...
class __TwigTemplate_2148ca9cc782f63389998269378d5ce2d3354cda025c1af5885409ec6bf7909a extends Template
{
    private $source;
    private $macros = [];
  ...
  <ul class=\"nav nav-pills m-2\">
    <li class=\"nav-item\">
      <a class=\"nav-link";
        // line 4
        echo (((0 === twig_compare(($context["active"] ?? null), "privileges"))) ? (" active") : (""));
        echo "\" href=\"";
...
echo _gettext("User accounts overview");
    ...
    ";
        ...
        <a class=\"nav-link";
            // line 10
            echo (((0 === twig_compare(($context["active"] ?? null), "user-groups"))) ? (" active") : (""));
            echo "\" href=\"";
